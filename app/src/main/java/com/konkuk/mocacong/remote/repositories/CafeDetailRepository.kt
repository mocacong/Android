...
class CafeDetailRepository  {
    ...
    suspend fun postReview(cafeId: String, reviewRequest: com.konkuk.mocacong.remote.models.request.ReviewRequest) : ApiState<Void> {
    ...
    suspend fun putReview(cafeId: String, reviewRequest: com.konkuk.mocacong.remote.models.request.ReviewRequest) : ApiState<Void> {
