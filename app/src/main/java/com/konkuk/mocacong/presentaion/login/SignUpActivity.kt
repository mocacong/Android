...
class SignUpActivity : AppCompatActivity() {
    ...
    private fun initLayout() {
        ...
        binding.registerBtn.setOnClickListener {
            ...
            if (msg == "") {
                val member = com.konkuk.mocacong.remote.models.request.SignUpRequest(
    ...
    private fun signUpEvent(member: com.konkuk.mocacong.remote.models.request.SignUpRequest) {
        var msg: String
        lifecycleScope.launch {
            ...
            if (msg == "성공") {
                signInEvent(
                    com.konkuk.mocacong.remote.models.request.SignInRequest(
                        member.email,
                        member.password
                    )
                )
